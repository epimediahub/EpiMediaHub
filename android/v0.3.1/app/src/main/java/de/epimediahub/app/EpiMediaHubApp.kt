...
fun EpiMediaHubApp(isTv: Boolean, vm: MainViewModel = viewModel()) {
    ...
    // Zentrale Absicherung für Android/Google-TV-Fernbedienungen:
    // Auf jeder Unterseite geht BACK genau eine EpiMediaHub-Ebene zurück.
    // Nur auf Home darf Android die Activity/App verlassen.
