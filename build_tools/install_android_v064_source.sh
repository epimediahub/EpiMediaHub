...
grep -Fq 'versionName = "0.6.4.3"' "$PROJECT_ROOT/app/build.gradle.kts"
grep -Fq 'versionCode = 606' "$PROJECT_ROOT/app/build.gradle.kts"
...
echo "Android v0.6.4.3 source reconstructed successfully with fast-list/live watchdog hotfix3"
