...
for v in v0.3.0 v0.3.1 v0.3.2 v0.3.3 v0.3.4 v0.3.5 v0.3.6 v0.4.0 v0.4.1 v0.4.2 v0.4.3 v0.4.4 v0.4.5 v0.4.6 v0.4.7 v0.4.8; do
...
PROJECT_ROOT="$PROJECT_ROOT" python3 android/v0.4.8/patch_v048.py

grep -q 'versionName = "0.4.8"' "$PROJECT_ROOT/app/build.gradle.kts"
grep -q 'versionCode = 48' "$PROJECT_ROOT/app/build.gradle.kts"
...
grep -Fq 'current?.BackendState == "NeedsLogin"' "$PROJECT_ROOT/app/src/main/java/de/epimediahub/app/RemoteTailscaleManager.kt"
grep -Fq 'http://epimedia.local:8787' "$PROJECT_ROOT/app/src/main/java/de/epimediahub/app/RemoteTailscaleManager.kt"
grep -Fq 'http://192.168.0.207:8787' "$PROJECT_ROOT/app/src/main/java/de/epimediahub/app/RemoteTailscaleManager.kt"
grep -Fq 'delay(10_000L)' "$PROJECT_ROOT/app/src/main/java/de/epimediahub/app/ui/V047WebAdmin.kt"
...
echo "Android v0.4.8 source reconstructed successfully"
