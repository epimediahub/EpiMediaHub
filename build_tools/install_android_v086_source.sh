...
grep -Fq 'versionName = "0.8.6"' "$PROJECT_ROOT/app/build.gradle.kts"
grep -Fq 'tracks.isTypeSupported' "$PROJECT_ROOT/app/src/main/java/de/epimediahub/app/ui/PlayerScreen.kt"
